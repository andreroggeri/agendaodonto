...
export const patientUnderMinimumRequiredAge = 'Pelo convênio só atendo clínico geral básico (como limpeza e restauração) em pacientes adultos.\n\nNão sou credenciada para atendimento odontopediatrico pelo convênio.';
